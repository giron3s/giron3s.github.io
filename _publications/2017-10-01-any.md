...
It is pretty cool. The Standard Library provide us the polymorphic wrapper capable of holding any type. 
...
The single problem with the std::any that is only available from C++17.
...
My conclusion is better to use the Standard Library rather than rolling a custom implementation. You are avoid code maintance. However the costum any class is a perfect approach when you can not use C++17, but you have to use the polymorphic wrapper. 
