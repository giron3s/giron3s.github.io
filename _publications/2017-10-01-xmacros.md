...
permalink: /publications/2010-10-01-xmacros
excerpt: 'X-Macros in C/C++'
tags:
  - Programming
  - Macros
  - Code generation
...
{% highlight c++ %}
	...
	const char* getStringFromAnimal(Color aColor)
	{
		switch (aColor)
		{
...
macros-evil-and-what-are-the-alternatives/14041847#14041847